...
<div class="container">
              ...
              <div class="col-lg-3 order-2 order-lg-1">
                ...
                <ul class="list-unstyled small text-muted ps-lg-4 font-weight-normal">
                 @foreach($category as $cat)
                  <li class="mb-2"><a class="reset-anchor" href="{{route('categoriesShop',$cat->id)}}">{{$cat->category_name}}</a></li>
                  @endforeach
                </ul>
    ...
    <form action="{{route('shopsearch')}}" method="get">
      <div class="input-group mb-3">
        @csrf
        <input type="text" class="form-control" name="shop_search" required placeholder="Search Shop Item" aria-label="Recipient's username" aria-describedby="basic-addon2">
        <div class="input-group-append">
          <button type="submit" class="input-group-text" id="basic-addon2">Search</button>
                  ...
                  <div class="col-lg-6 mb-2 mb-lg-0">
                    <p class="text-sm text-muted mb-0">Showing {{$count}} results</p>
                  </div>
