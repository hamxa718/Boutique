...
Route::get('/addproductAttribute/{id}', 'admin\productController@addproductAttribute')->name('addproductAttribute');
Route::post('/storeProductAttribute', 'admin\productController@storeProductAttribute')->name('storeProductAttribute');


Route::get('/destroyProductAttribute/{id}', 'admin\productController@destroyProductAttribute')->name('destroyProductAttribute');
Route::get('/productAttribute', 'admin\productController@productAttribute')->name('productAttribute');
//admin order routes
...
route::post('/addtocartwithqty','user\cartController@addtocartwithqty')->name('addtocartwithqty');
route::post('/qtyUpdate/{id}','user\cartController@qtyUpdate')->name('qtyUpdate');
